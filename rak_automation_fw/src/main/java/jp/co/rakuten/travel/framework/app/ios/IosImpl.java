...
public class IosImpl implements Ios, Equipment
{
    ...
    public void setupCapabilities()
    {
        ...
        // FIXME Get the app file from vm arguments
        String apkFileName = TestApiObject.instance().get( TestApiParameters.API_FTP_FILE_NAME );
        LOG.info( "Downloading app : " + apkFileName );
        ...
        m_capabilities.setCapability( PLATFORM, Platform.MAC );
        ...
        m_capabilities.setCapability( MobileCapabilityType.PLATFORM_NAME, "iOS" );
        m_capabilities.setCapability( MobileCapabilityType.PLATFORM_VERSION, TestApiObject.instance().get( TestApiParameters.API_PLATFORM_VERSION ) );
        m_capabilities.setCapability( MobileCapabilityType.AUTOMATION_NAME, "XCUITest" );
        m_capabilities.setCapability( MobileCapabilityType.DEVICE_NAME, "iPhone 6s" );
        ...
        m_capabilities.setCapability( MobileCapabilityType.NO_RESET, false );
        m_capabilities.setCapability( MobileCapabilityType.NEW_COMMAND_TIMEOUT, 300 );
        m_capabilities.setCapability( "useNewWDA", true );
    }
    ...
    public void onSetupDriver()
    {
        try
        {
            m_driver = new IOSDriver<>( new URL( TestApiObject.instance().get( TestApiParameters.DRIVER_SERVER_URL ) ), m_capabilities );
        }
        catch( MalformedURLException e )
        {
            m_driver = new IOSDriver<>( m_capabilities );
