...
/**
 * Reservation database instance to send query operation
 */
public class ReservationDatabaseController implements OracleDatabase
{
    protected TestLogger                                             LOG  = (TestLogger)TestLogger.getLogger( WebController.class );

    @SuppressWarnings( "unchecked" )
    OracleDatabaseConnection< java.sql.Driver, java.sql.Connection > m_db = (OracleDatabaseConnection< java.sql.Driver, java.sql.Connection >)Configuration.instance().equipment( EquipmentType.RESERVATION_DB );
