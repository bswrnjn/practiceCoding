...
/**
 * SLM database instance to manage SLM database connections
 */
public class SlmDatabaseImpl implements OracleDatabaseConnection< java.sql.Driver, java.sql.Connection >
{
    ...
    public void connect()
    {
        ...
        String url = TestApiObject.instance().get( TestApiParameters.API_SLM_DB_HOST ) //
                + ":" + TestApiObject.instance().get( TestApiParameters.API_SLM_DB_PORT ) //
                + "/" + TestApiObject.instance().get( TestApiParameters.API_SLM_DB_SERVICE_NAME );
        String username = TestApiObject.instance().get( TestApiParameters.API_SLM_DB_USER );
        String password = TestApiObject.instance().get( TestApiParameters.API_SLM_DB_PASSWORD );
        try
        {
