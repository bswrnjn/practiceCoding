...
import jp.co.rakuten.travel.framework.http.Transaction;

import org.apache.http.ParseException;
import org.apache.http.client.ClientProtocolException;

/**
 * Controller to handle Asynchronous operation with RESTful services
 *
 */
public interface RestApiAsyncController extends Controller
{
    /**
     * 
     ...
     * @param msg Transaction
     * @param uri {@link URI}
     * @return {@link void}
     * @throws IOException File not found
     * @throws ClientProtocolException URL issue or server error
     * @throws ParseException Format error
     */
    void postAsync( Transaction msg, URI uri ) throws IOException;
     ...
     * @throws ParseException Format error
     */
    void getAsync( URI uri ) throws IOException;
     ...
     * @throws ParseException Format error
     */
    void putAsync( Transaction msg, URI uri ) throws IOException;
     ...
     * @throws ParseException Format error
     */
    void deleteAsync( Transaction msg, URI uri ) throws IOException;
