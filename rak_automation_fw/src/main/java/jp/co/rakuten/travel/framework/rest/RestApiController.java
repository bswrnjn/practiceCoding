...
public interface RestApiController< T > extends Controller
{
    /**
     * 
     ...
     */
    T post( Transaction msg, URI uri ) throws IOException;
     ...
     * @throws ParseException Format error
     */
    T put( Transaction msg, URI uri ) throws IOException;
     ...
     * @throws ParseException Format error
     */
    T delete( Transaction msg, URI uri ) throws IOException;
